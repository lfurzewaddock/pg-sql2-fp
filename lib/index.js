...
const $$trusted = process.env.NODE_ENV === "production" ? Symbol("trusted") : Symbol.for("development"); /* eslint-disable-line prefer-const */
...
const $$trusted = (0, _trustedSymbol2.default)(); /* eslint-disable-line prefer-const */
